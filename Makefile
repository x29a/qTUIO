...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Mon Mar 15 18:11:09 2010
# Project:  qTUIO.pro
# Template: app
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NO_DEBUG -DQT_XML_LIB -DQT_OPENGL_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
$(TARGET): build/ui_qtuio.h $(OBJECTS)  
...
compiler_uic_make_all: build/ui_qtuio.h
compiler_uic_clean:
	-$(DEL_FILE) build/ui_qtuio.h
